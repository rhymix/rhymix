<?php
    ...
    class spamfilterController extends spamfilter {
        ...
        function insertIP($ipaddress) {
            ...
            $args->search_target = 'ipaddress';
            Context::set('search_target', 'ipaddress');
            $args->search_keyword = $ipaddress;
            Context::set('search_keyword', $ipaddress);
            $args->start_date = ((int)date('Ymd')-2).'0000'; // 이틀 전
