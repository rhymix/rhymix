<?php
    ...
    class ttimport {
        ...
        function importAttaches($fp, $module_srl, $upload_target_srl, &$files, $buff) {
            ...
            if(preg_match("/\.(jpg|jpeg|gif|png|wmv|wma|mpg|mpeg|avi|swf|flv|mp1|mp2|mp3|asf|wav|asx|mid|midi|asf|mov|moov|qt|rm|ram|ra|rmm|m4v)$/i", $file_obj->source_filename)) {
