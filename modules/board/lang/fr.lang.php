<?php
     ...
     * @brief  Paquet de la langue fondamental pour le module de Tableaux d\'Affichage
     **/

    $lang->board = "Tableaux d\'Affichage"; 
    ...
    $lang->cmd_board_list = 'Liste des Tableaux d\'Affichage';
    $lang->cmd_module_config = 'Configuration commun pour les Tableaux d\'Affichage';
    $lang->cmd_view_info = 'Information des Tableaux d\'Affichage';
    ...
    $lang->about_layout_setup = 'Vous pouvez manuellement modifier le code de Mise en Page du Tableau d\'Affichage. Insérez ou arrangez le code de Widget n\'importe où vous voulez.';
