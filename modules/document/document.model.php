<?php
    ...
    class documentModel extends document {
        ...
        /**
         * ê²Œì‹œë¬?ëª©ë¡??ê²€???µì…˜??Setting??2011.03.08 - cherryfilter)
		 * pageë³€?˜ê? ?†ëŠ” ?íƒœ?ì„œ page ê°’ì„ ?Œì•„?¤ëŠ” method(getDocumentPage)??ê²€?‰í•˜ì§€ ?Šì? ê°’ì„ return?´ì„œ ê²€?‰í•œ ê°’ì„ ê°€?¸ì˜¤?„ë¡ ê²€?‰ì˜µ?˜ì´ ì¶”ê? ??
		 * ê²€?‰ì˜µ?˜ì˜ ì¤‘ë³µ?¼ë¡œ ?¸í•´ private methodë¡?ë³„ë„ ë¶„ë¦¬
