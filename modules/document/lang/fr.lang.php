<?php
    ...
    // Search targets in admin page
        ...
        'is_secret' => 'Secret',
        'tags' => 'Tag',
        'readed_count' => 'Somme de Vues (dessus)',
        'voted_count' => 'Somme de Recommandations (dessus)',
        'comment_count ' => 'Somme de Commentaires (dessus)',
        'trackback_count ' => 'Somme de Retroliens (dessus)',
        'uploaded_count ' => 'Somme de Fichiers Attachés (dessus)',
