...
$lang->install_checklist_title['session_auto'] = 'session.auto_start 设置';
$lang->install_checklist_desc['permission'] = '[必须] 的安装路径或 ./files目录属性必须是777';
$lang->install_checklist_desc['xml'] = '[必须]为了 XML通讯，将需要XML库';
$lang->install_checklist_desc['session'] = '[必须] PHP会话必须可用';
$lang->install_checklist_desc['session_auto'] = '[必须] 为了使用缓冲功能，必须在php.ini当中设置 session.auto_start=0';
