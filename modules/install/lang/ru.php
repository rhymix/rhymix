...
$lang->install_checklist_title['session_auto'] = 'session.auto_start настройка';
...
$lang->install_checklist_desc['session'] = '[Требуется] PHP сессия должна быть доступна';
$lang->install_checklist_desc['session_auto'] = '[Требуется] Файл настроек PHP (php.ini) \'Session.auto_start\' должен быть равен нулю, чтобы Rhymix могла использовать сессии';
