...
$lang->install_checklist_title['session_auto'] = 'Thiết lập session.auto_start';
...
$lang->install_checklist_desc['session'] = '[Bắt buộc] Phiên PHP phầi có sẵn';
$lang->install_checklist_desc['session_auto'] = '[Bắt buộc] File thiết lập của PHP (php.ini) \'Session.auto_start\' phải là 0 theo thứ tự số cho phiên làm việc của Rhymix hoạt động.';
