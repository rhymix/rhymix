...
$lang->install_checklist_title['session_auto'] = 'Configuration de session.auto_start';
...
$lang->install_checklist_desc['session'] = '[Obligatoire] La session PHP doit être disponible';
$lang->install_checklist_desc['session_auto'] = '[Obligatoire] \'Session.auto_start\' dans le fichier de configuration pour PHP (php.ini) doit être égal à zéro car Rhymix utilise la session';
