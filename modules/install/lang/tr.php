...
$lang->install_checklist_title['session_auto'] = 'session.auto_start(otomatik.oturum_acma) ayarı';
...
$lang->install_checklist_desc['session'] = '[Gerekli] PHP oturumu mevcut olmalıdır';
$lang->install_checklist_desc['session_auto'] = '[Gerekli] PHP ayar dosyasındaki (php.ini) \'Session.auto_start\' Rhymix\'nin oturumu kullanabilmesi için sıfıra eşit olmalıdır';
