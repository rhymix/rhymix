...
dp.sh.Brushes.Cpp = function()
{
	...
	this.regexList = [
		...
		{ regex: new RegExp('^ *#.*', 'gm'),						css: 'dp-preprocessor' },
		{ regex: new RegExp(this.GetKeywords(datatypes), 'gm'),		css: 'dp-datatypes' },
		{ regex: new RegExp(this.GetKeywords(keywords), 'gm'),		css: 'dp-keyword' }
		];
