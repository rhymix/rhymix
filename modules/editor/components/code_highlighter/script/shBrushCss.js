dp.sh.Brushes.CSS = function()
{
	...
	this.regexList = [
		...
		{ regex: new RegExp('\\#[a-zA-Z0-9]{3,6}', 'g'),			css: 'dp-colors' },	// html colors
		{ regex: new RegExp('(\\d+)(px|pt|\:)', 'g'),				css: 'dp-string' },	// size specifications
		{ regex: new RegExp(this.GetKeywords(keywords), 'gm'),		css: 'dp-keyword' },	// keywords
		{ regex: new RegExp(this.GetKeywords(values), 'g'),			css: 'dp-string' },	// values
		{ regex: new RegExp(this.GetKeywords(fonts), 'g'),			css: 'dp-string' }		// fonts
		];
