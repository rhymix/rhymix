dp.sh.Brushes.Sql = function()
{
	...
	this.regexList = [
		{ regex: new RegExp('--(.*)$', 'gm'),						css: 'dp-comment' },			// one line and multiline comments
		...
		{ regex: new RegExp(this.GetKeywords(operators), 'gmi'),	css: 'dp-op' },				// operators and such
		{ regex: new RegExp(this.GetKeywords(keywords), 'gmi'),		css: 'dp-keyword' }			// keyword
		];
