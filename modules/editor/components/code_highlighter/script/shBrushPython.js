...
dp.sh.Brushes.Python = function()
{
	...
	this.regexList = [
		...
		{ regex: new RegExp('"""(.|\n)*?"""', 'gm'),					css: 'dp-string' },			// multi-line strings "
		{ regex: new RegExp("'''(.|\n)*?'''", 'gm'),					css: 'dp-string' },			// multi-line strings '
...
//		{ regex: dp.sh.RegexLib.SingleQuotedString,					css: 'dp-string' },			// single quoted strings
		...
		{ regex: new RegExp(this.GetKeywords(builtins), 'gm'),		css: 'dp-builtins' },			// builtin objects, functions, methods, magic attributes
		{ regex: new RegExp(this.GetKeywords(magicmethods), 'gm'),	css: 'dp-magicmethods' },		// special methods
		{ regex: new RegExp(this.GetKeywords(exceptions), 'gm'),	css: 'dp-exceptions' },		// standard exception classes
		{ regex: new RegExp(this.GetKeywords(types), 'gm'),			css: 'dp-types' },				// types from types.py
		{ regex: new RegExp(this.GetKeywords(commonlibs), 'gm'),	css: 'dp-commonlibs' }			// common standard library modules
		];
