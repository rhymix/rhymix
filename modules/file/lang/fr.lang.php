<?php
    ...
    $lang->enable_download_group = 'Groupe autorisé à Télécharger';
    ...
    $lang->about_allowed_filetypes = 'Extensions consentis seulement peuvent être attachés. Pour consentir une extension, utilisez "*.[extention]". Pour consentir plusieurs extensions, utilisez ";" entre chaque extension.<br />ex) *.* or *.jpg;*.gif;<br />(Exclure Administraterrs)';

    $lang->cmd_delete_checked_file = 'Supprier item(s) sélectionné(s)';
    $lang->cmd_move_to_document = 'Bouger au Document';
    $lang->cmd_download = 'Télécharger';

    $lang->msg_not_permitted_download = 'Vous n\'êtes pas autorisé à télécharger';
    ...
    $lang->search_target_list = array(
        ...
        'download_count' => 'Somme de Téléchargé (surplus)',
        'regdate' => 'Jour de Renrégistrer',
