<?php
  /**
    ...
    $lang->about_widget_code = 'Пожалуйста, сначала введите тредуемые значения, и затем щелкните кнопку [Генерировать Код] для генерации кода и добавления его в файл шаблона.';
