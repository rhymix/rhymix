...
$lang->msg_limit_mid = '모듈 주소에는 영문, 숫자, 언더바(_), 하이픈(-)을 사용할 수 있으며, 첫 글자는 반드시 영문이어야 합니다.';
$lang->msg_limit_mid_compat = '모든 형태의 짧은주소를 사용하지 않는 경우, 모듈 주소는 슬래시(/)나 하이픈(-)을 포함할 수 없습니다.';
...
$lang->installed_plugins = '설치된 플러그인';
$lang->plugin_name = '플러그인 이름';
$lang->plugin_enable = '사용';
$lang->plugin_license = '라이선스';
