<?php
    ...
    $lang->about_search_list_count = '검색, 카테고리 선택 등을 할 경우 표시될 글의 수를 지정하실 수 있습니다. (기본 20개)';
    $lang->about_page_count = '목록 하단, 페이지를 이동하는 링크의 수를 지정하실 수 있습니다. (기본 10개)';
    ...
    $lang->about_search_virtual_site = '가상 사이트(예:cafeXE)의 도메인을 입력하신 후 검색하세요.<br/>가상 사이트 이외의 모듈은 내용을 비우고 검색하시면 됩니다. (http:// 는 제외)';
