...
$lang->msg_limit_mid = 'Module URLs can only contain alphabets, numbers, underscores(_), and hyphens(-). The first character must be an alphabet.';
$lang->msg_limit_mid_compat = 'If not using all types of short URLs, the module URL cannot contain slashes (/) or hyphens (-).';
...
$lang->about_multilingual_manage['link'] = 'Content>Multilingual';
