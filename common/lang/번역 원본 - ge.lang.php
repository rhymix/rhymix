...
/ / 여기 에서부터 번역 시작 필요 ..
     ...
     $lang-> Blog = 'Blog';
     $lang-> Geburtstag = 'Geburtstag';
     $lang-> browser_title = 'Browser-Titel';
     $lang-> title = 'Betreff';
     $lang-> title_content = 'Betreff + Inhalt';
     $lang-> topic = 'Thema';
     $lang-> Antworten = 'Antwort';
     $lang-> content = "Inhalt";
     $lang-> Dokument = 'Artikel';
     ...
     $lang-> Zuschuss = 'Erlaubnis';
     $lang-> target = 'target';
     $lang-> total = 'Gesamt';
     $lang-> total_count = 'count Gesamt';
     $lang-> ipadresse = 'IP-Adresse';
     $lang-> path = 'Pfad';
     $lang-> Warenkorb = 'Ausgewählte Posten';
     $lang-> Freund = 'Freunde';
     $lang-> notify = 'Meldung';
