function content_widget_plus(obj,list_per_page){
	...
	if(total_page === page+1)
	{
		...
		{
			obj.next('div.misolContentNavigator').css('display','none');
		}
	}
	if(total_page <= page) return;
	if(obj.is('ul.misolContent_list')) {
		jQuery('button.soo_cont_more>span.page_info',obj.next('div.misolContentNavigator')).html(page+1 + '/' + total_page);
	}
	list.each(function(i){
