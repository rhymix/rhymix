...
자신을 표현하고 커뮤니티를 키워나갈 수 있도록 돕기 위한 CMS(content management system) 겸 프레임워크입니다.
...
중앙집중형 SNS 플랫폼에 의존하지 않고도 누구나 사이버 공간에 당당하게 집을 짓고 서로 소통할 수 있는 미래를 만들어가길 원합니다.

서비스 제공자 위주로 흘러가는 현대의 IT 동향을 무차별적으로 받아들이기보다는
사용자의 주권과 열린 인터넷 환경을 보호하는 기술을 집중적으로 발굴하며,
우리나라 인터넷 커뮤니티의 유기적 성장을 이끌었던 제로보드와 XE의 정신을 이어받아
오픈 웹을 지키고 회복시키는 일에 앞장서고자 합니다.
...
Rhymix is a content management system (CMS) and web framework
for everyone who wants to create independent homepages to express themselves and build their communities easily and freely.
...
Rather than indiscriminately accepting modern IT trends that represent the interests of major service providers, 
we focused on technologies that protect users' sovereignty and open Internet environment.
Continuing the spirit of ZeroBoard and XpressEngine, which led the organic growth of Korean internet communities,
Rhymix wants to take the lead in recovering and restoring the open web.
